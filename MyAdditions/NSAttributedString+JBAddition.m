//
//  NSAttributedString+JBAddition.m
//  工具类整理
//
...
#import "NSAttributedString+JBAddition.h"

@implementation NSAttributedString (JBAddition)

+ (instancetype)jb_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {
